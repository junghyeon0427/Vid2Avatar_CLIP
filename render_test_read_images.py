...
# python render_test_read_images.py --rgb_gt_dir ./outputs/Video/parkinglot_csc_clip_spatial/rgb_gt --rgb_pred_dir ./outputs/Video/parkinglot_csc_clip_spatial/test_fg_rendering